    ...
    return (
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden py-24 px-6">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center text-center">
                ...
                >
                    <p className="text-lg md:text-xl text-zinc-400 font-mono leading-relaxed mb-8">
                        Agentes de IA, automações e produtos digitais que trabalham enquanto você dorme.
                        <strong className="text-white font-bold inline-block ml-2 border-b-2 border-primary">20 anos. 1 ano de mercado. Resultados reais.</strong>
                    </p>
